...
formats = [
    ...
    'Genbank', 'Imgt', 'Phd', 'Pir', 'Seqxml', 'Sff', 'Swiss', 'Uniprotxml',
]
unwriteable = ['Abi', 'Ace', 'Pir', 'Swiss', 'Uniprotxml']
tpl = '''
<tool id="CONVERTER_{from_format}_to_{to_format}_0" name="Convert {from_format} to {to_format}" version="1.0.0">
    <command interpreter="python">
        generic_seqio.py $input1 {from_format} $output1 {to_format}
    </command>
    <inputs>
